<?php
   ...
   $sql = "SELECT * FROM citas WHERE Identificador = '$identificador'";
...
<html lang="es">
   <head>
      ...
      <title>Actualizar datos de Citas</title>
   </head>
   <body>
                          <header>
         <div>
     ...
     <div class="container pt-5 pb-5" style="background-color: #FFFFFF">
            ...
            <hr class="my-5">
      <form method="post" action="../../operacionesPhp/crudeCita/modificarCita.php">
         <div class="form-row">
            <div class="form-group col-md-6">
               <label for="inputEmail4">Nombre</label>
               <input type="text" class="form-control" id="nombre" placeholder="Nombre" name="nombre" value="<?php echo $row['Nombre']?>" required>
            </div>
            <div class="form-group col-md-6">
               <label for="inputPassword4">Fecha</label>
               <input type="text" class="form-control" id="fecha" name="fecha" value="<?php echo $row['Fecha']?>" required>
            </div>
         </div>
         <div class="form-group">
            <label for="inputAddress">Hora</label>
            <input type="text" class="form-control" id="hora" placeholder="hora" name="hora" value="<?php echo $row['Hora']?>" required>
         </div>
         <div class="form-group">
            <label for="inputAddress">Motivo</label>
            <input type="text" class="form-control" id="motivo" placeholder="motivo" name="motivo" value="<?php echo $row['Motivo']?>" required>
         </div>         
         <div>
         ...
         <button type="submit" class="btn btn-secondary"><a href="controlCitas.php"></a>Cancelar</button>
         </div>
      </form>
              </div>       
           </div> 
