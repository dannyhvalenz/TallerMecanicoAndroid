...
$sql = "SELECT * FROM refacciones WHERE idRefaccion='$identificador'";
...
<head>
    ...
    <title>Actualizando los datos de las refacciones</title>
</head>
...
<body>
    ...
    <div class="container pt-5 pb-5" style="background-color: #FFFFFF">
        <div class="row">
            <div class="col-lg-2" aling="right">
                <img src="../../imagenes/actualizar/auto.png" width="120px" height="120px">
            </div>

            <div class="col-lg-10 pr-5" aling="left">
        ...
        <form method="post" action="../../operacionesPhp/crudeRefaccion/modificarRefaccion.php">
            <div class="form-row">
                <div class="form-group col-md-6">
                    <!-- <input type="hidden" class="form-control" id="cost" name="matri" value="<?php echo $row['Matricula']?>" required> -->
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <input t type="text" class="form-control" name="descripcion"
                    value="<?php echo $row['descripcionRefaccion']?>" required>
            </div>

            <div class="form-group">
                <label for="inputAddress">Unidad</label>
                <input t type="text" class="form-control" name="unidad" value="<?php echo $row['unidadRefaccion']?>"
                    required>
            </div>

            <div class="form-group">
                <label for="inputAddress">Precio</label>
                <input t type="text" class="form-control" name="precio" value="<?php echo $row['precioRefaccion']?>"
                    required>
            </div>

            <div>
                <input type="hidden" id="id" name="id" value="<?php echo $row['idRefaccion']?>" required>
            ...
            <div aling="center">
                ...
                <button type="submit" class="btn btn-secondary"><a href="controlRefacciones.php"></a>Cancelar</button>
            </div>
        </form>
    </div>
