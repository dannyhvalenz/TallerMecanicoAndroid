...
public class MenuInventarioActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_registrar_administrador) {
            Intent intent = new Intent(MenuInventarioActivity.this, RegisterAdministradorActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_clientes) {
            Intent intent = new Intent(MenuInventarioActivity.this, MenuPrincipalActivity.class);
            startActivity(intent);
            finish();
        } else if (id == R.id.nav_citas) {
            Intent intent = new Intent(MenuInventarioActivity.this, MenuCitasActivity.class);
            startActivity(intent);
            finish();
            ...
            Intent intent = new Intent(MenuInventarioActivity.this, MenuHerramientasActivity.class);
            startActivity(intent);
            finish();
    ...
    public void btn_float_registrar_inventario (View view){
        Intent intent = new Intent(MenuInventarioActivity.this, RegistrarClienteActivity.class);
        startActivity(intent);
    }
}
