...
public class ActualizarAutomovilActivity extends AppCompatActivity {
    ...
    public void btn_actualizar_automovil(View view){
        ...
        if (TextUtils.isEmpty(marca)) {
        ...
        }else if (!TextUtils.isEmpty(marca) && !TextUtils.isEmpty(linea) && !TextUtils.isEmpty(modelo) && !TextUtils.isEmpty(color)) {
            ...
            firebase.child("Cliente").child(recibonombre).child("Automovil").child(placaAntigua).child("color").setValue(color);
            firebase.child("Cliente").child(recibonombre).child("Automovil").child(placaAntigua).child("linea").setValue(linea);
            firebase.child("Cliente").child(recibonombre).child("Automovil").child(placaAntigua).child("marca").setValue(marca);
            firebase.child("Cliente").child(recibonombre).child("Automovil").child(placaAntigua).child("modelo").setValue(modelo);
