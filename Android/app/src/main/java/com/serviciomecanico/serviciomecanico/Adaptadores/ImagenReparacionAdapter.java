...
public class ImagenReparacionAdapter extends RecyclerView.Adapter<ImagenReparacionAdapter.ViewHolder> {
    ...
    public ImagenReparacionAdapter(Context context, ArrayList<String> imageUrls) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_avatar_reparacion, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            image = itemView.findViewById(R.id.imageReparacion);
        }
    }
}
